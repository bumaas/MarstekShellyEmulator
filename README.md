...
- `Sende-Host` und `Sende-Port` können optional gesetzt werden, um Antworten bzw. Anfragen auf die erwartete Gegenstelle einzugrenzen. Das ist ein Filter und keine Grundvoraussetzung für den Betrieb.
